...
public class EmmThread {
    ...
    public EmmThread(int color) {
        this.color = 0xFF000000 | color;
    }

    public EmmThread(int color, String description) {
        this.color = 0xFF000000 | color;
        this.description = description;
    }

    public EmmThread(int color, String description, String catalogNumber, String brand, String chart) {
        this.color = 0xFF000000 | color;
        this.description = description;
    ...
    public EmmThread(int color, String description, String catalogNumber) {
        this.color = 0xFF000000 | color;
        this.description = description;
        this.catalogNumber = catalogNumber;
    }

    public EmmThread(int red, int green, int blue, String description, String catalogNumber) {
        this.color = newColor(red,green,blue);
        this.description = description;
        this.catalogNumber = catalogNumber;
    }

    public EmmThread(EmmThread embthread) {
    ...
    public EmmThread(int red, int green, int blue, String description, String catalogNumber, String brand, String chart) {
        this.color = newColor(red,green,blue);
        this.description = description;
        this.catalogNumber = catalogNumber;
        this.brand = brand;
    ...
    public boolean equals(Object o) {
        ...
        EmmThread emmThread = (EmmThread) o;

        if (color != emmThread.color) return false;
        if (description != null ? !description.equals(emmThread.description) : emmThread.description != null)
            return false;
        if (catalogNumber != null ? !catalogNumber.equals(emmThread.catalogNumber) : emmThread.catalogNumber != null)
            return false;
        if (details != null ? !details.equals(emmThread.details) : emmThread.details != null)
            return false;
        if (brand != null ? !brand.equals(emmThread.brand) : emmThread.brand != null) return false;
        if (chart != null ? !chart.equals(emmThread.chart) : emmThread.chart != null) return false;
        return weight != null ? weight.equals(emmThread.weight) : emmThread.weight == null;
    }

    public static <T extends EmmThread> int findNearestColor(int findColor, T[] values) {
        return findNearestThread(findColor, values).getColor();
    }

    public static <T extends EmmThread> int findNearestColor(int findColor, List<T> values) {
        return findNearestThread(findColor, values).getColor();
    }

    public static <T extends EmmThread> T findNearestThread(int findColor, T[] values) {
        int index = EmmThread.findNearestIndex(findColor, values);
        return values[index];
    }

    public static <T extends EmmThread> T findNearestThread(int findColor, List<T> values) {
        int index = findNearestColorIndex(findColor, values);
        return values.get(index);
    }

    public static <T extends EmmThread> int findNearestIndex(int findColor, T[] values) {
    ...
    public static <T extends EmmThread> int findNearestColorIndex(int findColor, Iterable<T> values) {
        double currentClosestValue = Double.POSITIVE_INFINITY;
        int red = (findColor >> 16) & 0xff;
        int green = (findColor >> 8) & 0xff;
        int blue = (findColor) & 0xff;
    ...
    public String toString() {
        return "EmmThread{" + "description=" + description + ", catalogNumber=" + catalogNumber + ", brand=" + brand + ", " + this.getHexColor() + '}';
    }
