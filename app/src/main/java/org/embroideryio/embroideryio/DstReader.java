...
public class DstReader extends EmbReader {
    ...
    public void process_header_info(String prefix, String value) {
        switch (prefix) {
            case "LA":
    ...
    public void dst_read_header() throws IOException {
        ...
        for (String s : split) {
            ...
            process_header_info(s.substring(0, 2), s.substring(3).trim());
        }
    }

    public void dst_read_stitches() throws IOException {
